...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        number_of_auhtors = 13

        for author_id in range(number_of_auhtors):
...
class RenewBookInstanceViewTest(TestCase):
    def setUp(self):
        ...
        # BookInstance object for test_user2
        return_date = datetime.date.today() + datetime.timedelta(days=5)
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        #  because the redirect URL is unprdictable)
    ...
    def test_HTTP404_for_valid_book_if_logged_in(self):
        test_uid = uuid.uuid4()
        login = self.client.login(username='testuser2', 
            password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse('renew-book-librarian', 
...
class AuthorCreateList(TestCase):
    def setUp(self):
        test_user1 = User.objects.create_user(username='testuser1', 
            password='1X<ISRUkw+tuK')
        test_user2 = User.objects.create_user(username='testuser2', 
    ...
    def test_redirects_to_author_list_on_success(self):
        ...
        response = self.client.post(reverse('author-create'), 
            {'first_name': 'Simon', 'last_name': 'Lname'})
